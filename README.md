Dev Build:: 
  ...
  [![Front](https://img.shields.io/badge/Front-VUE-d.svg)](#) [![sdk](https://img.shields.io/badge/sdk-5.0.1-d.svg)](#)  [![Build status](https://github.com/anjoy8/lyprojectapi/workflows/.NET%20Core/badge.svg)](https://github.com/anjoy8/LYProjectApi/actions) [![codecov](https://codecov.io/gh/anjoy8/LYProjectApi/branch/master/graph/badge.svg)](https://codecov.io/gh/anjoy8/LYProjectApi)  [![License MIT](https://img.shields.io/badge/license-Apache-blue.svg?style=flat-square)](https://github.com/anjoy8/LYProjectApi/blob/master/LICENSE) [![Language](https://img.shields.io/badge/language-csharp-d.svg)](#) 
[![star this repo](http://githubbadges.com/star.svg?user=anjoy8&repo=lyprojectapi&style=flat)](https://github.com/boennemann/badges) 
[![fork this repo](http://githubbadges.com/fork.svg?user=anjoy8&repo=lyprojectapi&style=flat)](https://github.com/boennemann/badges/fork) 
...
LYProjectApi 开箱即用的企业级前后端分离【 .NET Core5.0 Api + Vue 2.x + RBAC】权限框架。
已被多家公司所使用：[点击查看列表](https://github.com/anjoy8/LYProjectApi/issues/75)
...
- [x] 封装`LYProjectApi.Webapi.Template`项目模板，一键重建自己的项目 ✨；
...
![系统架构图](http://apk.neters.club/LYProjectApi.System.Architecture.png)
...
数据查看：[LYProjectApi.Data.json](https://github.com/anjoy8/Blog.Data.Share/tree/master/BlogCore.Data.json)
...
| ------- | -------- | ------- |
| [LYProjectApi.Webapi.Template](https://www.nuget.org/packages/LYProjectApi.Webapi.Template/) | [![LYProjectApi.Webapi.Template](https://img.shields.io/nuget/v/LYProjectApi.Webapi.Template.svg)](https://www.nuget.org/packages/LYProjectApi.Webapi.Template/)  | [![LYProjectApi.Webapi.Template](https://img.shields.io/nuget/dt/LYProjectApi.Webapi.Template.svg)](https://www.nuget.org/packages/LYProjectApi.Webapi.Template/) |
...
|[NetCore-Sugar-Demo](https://github.com/anjoy8/NetCore-Sugar-Demo)|[Blog.SplRepository.Demo](https://github.com/anjoy8/Blog.SplRepository.Demo)|[LYProjectApi](https://github.com/anjoy8/LYProjectApi)|[ChristDDD](https://github.com/anjoy8/ChristDDD)|
