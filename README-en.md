[ENGLISH](https://github.com/anjoy8/LYProjectApi/blob/master/README-en.md) | [中文版](https://github.com/anjoy8/LYProjectApi/blob/master/README.md)


![Logo](https://github.com/anjoy8/LYProjectApi/blob/master/LYProjectApi/wwwroot/logocore.png)
...
*********************************************************
# Tips: 
1. LYProjectApi.FrameWork project is a simple implementation of generating files using T4 templates.
...
1, in the LYProjectApi.Repository layer under the Sugar folder under the BaseDBConfig.cs, configure their own strings
``` 
...
```
2, in the LYProjectApi.FrameWork layer of the dbhelper.ttinclude, configure their own strings
``` 
...
Blog Park: https://www.cnblogs.com/laozhang-is-phi/
 ...
 Code Cloud: Https://gitee.com/laozhangIsPhi/LYProjectApi
