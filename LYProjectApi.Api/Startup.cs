...
using LYProjectApi.Extensions;
using LYProjectApi.Filter;
using LYProjectApi.Hubs;
using LYProjectApi.IServices;
using LYProjectApi.Middlewares;
using LYProjectApi.Model.Seed;
using LYProjectApi.Tasks;
...
namespace LYProjectApi
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, MyContext myContext, ITasksQzServices tasksQzServices, ISchedulerCenter schedulerCenter, IHostApplicationLifetime lifetime)
        {
            ...
            // 封装Swagger展示
            app.UseSwaggerMildd(() => GetType().GetTypeInfo().Assembly.GetManifestResourceStream("LYProjectApi.Api.index.html"));
