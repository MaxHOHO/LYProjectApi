...
namespace LYProjectApi.Model.Seed
{
    public class FrameSeed
    {
        ...
        public static bool CreateControllers(SqlSugarClient sqlSugarClient, string ConnId = null, bool isMuti = false, string[] tableNames = null)
        {
            ...
            Create_Controller_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\LYProjectApi.Api.Controllers", "LYProjectApi.Api.Controllers", tableNames, "", isMuti);
            return true;
        ...
        public static bool CreateModels(SqlSugarClient sqlSugarClient, string ConnId, bool isMuti = false, string[] tableNames = null)
        {
            ...
            Create_Model_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\LYProjectApi.Model", "LYProjectApi.Model.Models", tableNames, "", isMuti);
            return true;
        ...
        public static bool CreateIRepositorys(SqlSugarClient sqlSugarClient, string ConnId, bool isMuti = false, string[] tableNames = null)
        {
            ...
            Create_IRepository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\LYProjectApi.IRepository", "LYProjectApi.IRepository", tableNames, "", isMuti);
            return true;
        ...
        public static bool CreateIServices(SqlSugarClient sqlSugarClient, string ConnId, bool isMuti = false, string[] tableNames = null)
        {
            ...
            Create_IServices_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\LYProjectApi.IServices", "LYProjectApi.IServices", tableNames, "", isMuti);
            return true;
        ...
        public static bool CreateRepository(SqlSugarClient sqlSugarClient, string ConnId, bool isMuti = false, string[] tableNames = null)
        {
            ...
            Create_Repository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\LYProjectApi.Repository", "LYProjectApi.Repository", tableNames, "", isMuti);
            return true;
        }
        ...
        public static bool CreateServices(SqlSugarClient sqlSugarClient, string ConnId, bool isMuti = false, string[] tableNames = null)
        {
            ...
            Create_Services_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\LYProjectApi.Services", "LYProjectApi.Services", tableNames, "", isMuti);
            return true;
...
using LYProjectApi.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
    ...
    public interface I{ClassName}Services :IBaseServices<{ClassName}>" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
	{
          ...
          bool isMuti = false)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
@"using LYProjectApi.IRepository" + (isMuti ? "." + ConnId + "" : "") + @";
using LYProjectApi.IRepository.UnitOfWork;
using LYProjectApi.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
    ...
    public class {ClassName}Repository : BaseRepository<{ClassName}>, I{ClassName}Repository" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
    {
          ...
          bool isMuti = false)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
@"
using LYProjectApi.IServices" + (isMuti ? "." + ConnId + "" : "") + @";
using LYProjectApi.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
